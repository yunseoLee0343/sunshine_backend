...
class SensorReading(Base):
    ...
    humidity_pct: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
    light_lux: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
    soil_moisture_pct: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
